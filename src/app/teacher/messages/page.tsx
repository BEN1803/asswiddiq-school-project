    ...
    <div className="space-y-8">
      <div className="bg-white/80 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-white/20">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Communicate with parents, students, and colleagues</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
            <div className="text-3xl font-bold text-blue-600 mb-2">12</div>
            <div className="text-sm font-medium text-blue-800">Unread Messages</div>
          </div>
          <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl">
            <div className="text-3xl font-bold text-green-600 mb-2">8</div>
            <div className="text-sm font-medium text-green-800">Sent Today</div>
          </div>
        ...
        <div className="space-y-4">
          {[
            { from: 'Sarah Johnson (Parent)', subject: 'Question about math homework', time: '2 hours ago', read: false, type: 'parent' },
            { from: 'Principal Office', subject: 'Staff meeting tomorrow', time: '4 hours ago', read: true, type: 'admin' },
            { from: 'Mike Chen (Parent)', subject: 'Thank you for extra help', time: '1 day ago', read: true, type: 'parent' },
            { from: 'Department Head', subject: 'Curriculum updates', time: '2 days ago', read: false, type: 'admin' },
          ].map((message, index) => (
            <div key={index} className={`border border-gray-200/50 p-6 rounded-xl hover:shadow-lg transition-all duration-300 ${message.read ? 'bg-white/50' : 'bg-blue-50/50 border-blue-200'}`}>
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                      message.type === 'parent' ? 'bg-green-100 text-green-800' :
